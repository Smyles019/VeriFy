...
const EditorSidebar = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <ul className="p-4 space-y-4">
        ...
        <li><a href="#" className="text-blue-700 hover:underline">All Articles</a></li>
        <li><a href="#" className="text-blue-700 hover:underline">Approved</a></li>
        <li><a href="#" className="text-blue-700 hover:underline">Pending</a></li>
